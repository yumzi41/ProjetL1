...
$formNewPost =  Auther\MotorTemplate::cForm("formNewPost","POST","Main?space=userinterface&update=true", $titleNewPost . $descriptionNewPost . $submitButtonNewPost . $buttonInvisibleFormNewPost);
